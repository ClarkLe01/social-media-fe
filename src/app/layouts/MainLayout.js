...
import { AppShell, Navbar, Header, Footer, Aside, Text, MediaQuery, Burger, useMantineTheme, NavLink, ScrollArea, Transition, TextInput, ActionIcon } from '@mantine/core';
import { Link, Outlet } from 'react-router-dom';
import { IconSearch, IconMoon, IconMessageCircle, IconSettings, IconUser, IconHome, IconFriends, IconArrowLeft } from '@tabler/icons-react';
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', height: '100%' }}>
                        ...
                        <MediaQuery largerThan="sm" styles={{ display: 'none' }}>
                            <div>
                                ...
                                <Transition mounted={openSearch} transition={scaleY} duration={200} timingFunction="ease-in-out">
                                    {() => (
                                        <form action="#" className="bg-white float-left h-100 z-3 position-absolute top-0 start-0 w-100  " style={ { zIndex: 101 } }>
                                            <ActionIcon className='d-inline-block ms-3' variant="transparent"><IconArrowLeft size={42} /></ActionIcon>
                        ...
                        <Link to="/message" className="p-2 text-center ms-3 menu-icon chat-active-btn">
                            <IconMessageCircle />
                        </Link>
